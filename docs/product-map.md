# Product map — Digital Office Spaces (DOS) lineage
...
*Last updated: 2026-07-20 (DOS product branch from World Studio)*

### DOS cut (this repo)

This tree is **Digital Office Spaces**: collaborative office world builder for humans and agents — data, schedules, and chats in-space, **TUI-first**. The sections below retain the broader ADM / Silo / World Studio doctrine inherited from the parent product so we do not lose context.

Related: [ORIGIN.md](../ORIGIN.md) · [IDEAS.md](../IDEAS.md) · [CHANGELOG.md](../CHANGELOG.md) · [GITHUB.md](../GITHUB.md)

---

## Purpose of this document

- Hold the **larger product map** while DOS focuses the tool on **office collab**.
...
| Step | Meaning |
|------|---------|
| **VEN** | **Virtual Entity** *and* **Variable Energy Node** on the totalizing grid of the fabric of herenow. In the model: prime / instance furniture — not yet agenic. Production of properties/types/shells lives in **VEN Mentor**, not only “world entity” language. |
